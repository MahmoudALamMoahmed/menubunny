          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              ...
              <div className="relative">
                <Button variant="outline" className="w-full justify-start" disabled={!restaurant || !(limits?.features as any)?.dashboard_orders} onClick={() => restaurant && navigate(`/${restaurant.username}/orders`)}>
              ...
              <div className="relative">
                <Button variant="outline" className="w-full justify-start" disabled={!restaurant || !(limits?.features as any)?.analytics} onClick={() => restaurant && navigate(`/${restaurant.username}/whatsapp-analytics`)}>
                  <MessageCircle className="w-4 h-4 ml-2" />
                  تقارير واتساب
                </Button>
                {limits && !(limits.features as any)?.analytics && (
