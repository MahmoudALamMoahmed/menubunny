                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="space-y-2">
                          ...
                          {order.customer_address && (<div className="flex items-start gap-2"><MapPin className="w-4 h-4 text-gray-400 mt-1" /><span className="font-medium">العنوان:</span><span className="flex-1">{order.customer_address}</span></div>)}
                          {!order.customer_address && order.notes && (<div className="flex items-start gap-2"><MapPin className="w-4 h-4 text-gray-400 mt-1" /><span className="font-medium">ملاحظات:</span><span className="flex-1">{order.notes}</span></div>)}
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span>
                                {order.payment_method === 'vodafone' ? 'فودافون كاش' :
                                 order.payment_method === 'etisalat' ? 'اتصالات كاش' :
                                 order.payment_method === 'orange' ? 'اورانج كاش' : 'الدفع عند الاستلام'}
                              </span>
                            </div>
                          )}
                        </div>
